        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Store = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_category_goals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_category_goals_categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    StoreExact = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    StoreContains = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_category_mappings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_category_mappings_categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "categories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_transaction_categories_categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_transaction_categories_transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_category_goals_CategoryId",
                table: "category_goals",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_category_mappings_CategoryId",
                table: "category_mappings",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_category_mappings_UserId",
                table: "category_mappings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_transaction_categories_CategoryId",
                table: "transaction_categories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_transaction_categories_TransactionId",
                table: "transaction_categories",
